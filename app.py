...
# ==========================================
    ...
    if st.session_state.step == 1:
        ...
        st.markdown('<div class="alert-box"><b>🗓️ Note:</b> Badminton requires non-marking shoes.</div>', unsafe_allow_html=True)
        ...
        if col2.button("Configure Match Rules ➡️"):
            if sports:
                ...
                st.session_state.form_data['game_rules'] = {} 
    ...
    # --- STEP 10: CONFIGURATION (HTML Wrappers Purged completely) ---
        ...
        with st.container():
            ...
            if game == "Cricket":
                ...
                st.info("No advanced configurations needed for this selection. Click Next Event to proceed.")
